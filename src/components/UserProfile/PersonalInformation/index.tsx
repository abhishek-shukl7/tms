...
return (
    <div id="profile2" className={activeIndex === 1 ? 'tab-pane fade active show' : 'tab-pane fade'}>
                                 <div className="row">
                                                ...
                                                <div className="card-body p-3">
                                                   <ul className="list-inline p-0 m-0">
                                                      <li className="mb-2 d-flex">
                                                         <span><i className="lab la-facebook-f icon-text-primary font-size-20 mr-3"></i></span>
                                                         <p className="mb-0 line-height">fb.me/nataliedawson</p>
                                                      </li>
                                                      <li className="mb-2 d-flex">
                                                         <span><i className="lab la-twitter icon-text-info font-size-20 mr-3"></i></span>
                                                         <p className="mb-0 line-height">@nataliedawson</p>
                                                      </li>
                                                      <li className=" d-flex">
                                                         <span><i className="lab la-instagram  icon-text-danger font-size-20 mr-3"></i></span>
