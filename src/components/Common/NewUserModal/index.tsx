...
const NewUserModal: React.FC<ModalProps> = ({ active, onClose }) => {
  return (
    <div
    className={`${active ? 'modal fade bd-example-modal-lg show' : 'modal fade bd-example-modal-lg'}`} onClick={onClose}
      role="dialog"
      aria-modal="true"
      id="new-user-modal"
    >
      ...
      >
        <div className="modal-content">
          <div className="modal-header d-block text-center pb-3 border-bttom">
            <h3 className="modal-title" id="exampleModalCenterTitle02">
              New User
            </h3>
          </div>
          <div className="modal-body">
            <div className="row">
              ...
              <div className="col-lg-6">
                <div className="form-group mb-3">
                  <label htmlFor="exampleInputText04" className="h5">
                    Phone Number
                  </label>
                  <input
                    type="text"
              ...
              <div className="col-lg-6">
                <div className="form-group mb-3">
                  <label htmlFor="exampleInputText006" className="h5">
                    Email
                  </label>
                  <input
                    type="text"
